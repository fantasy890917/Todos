...
public class TodosListAdapter extends BaseAdapter implements QueryListener,
    ...
    public TodosListAdapter(Context context) {
        ...
        /**
         * TodosListAdapter实现 QueryListener接口
         * 重写startQuery()/onQueryComplete()方法
         * 在 startQuery()中调用TodoAsyncQuery的startQuery()
         * 然后会执行TodoAsyncQuery的onQueryComplete()方法在此方法
        ...
        }回调this adapter的onQueryComplete()将实现都放在adapter中 ***/
        
        /**
         *  TimeChangeReceiver.TimeChangeListener
         *  实现void onDateChange();void onTimePick();
         *  在TodosActivity中
